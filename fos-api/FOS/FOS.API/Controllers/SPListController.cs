...
namespace FOS.API.Controllers
{
    public class SPListController : ApiController
    {
        ...
        public async Task<HttpResponseMessage> AddListItem(string Id, [FromBody]string item)
        {
            var SiteId = WebConfigurationManager.AppSettings[OAuth.SITE_ID];
            HttpClient client = new HttpClient();
            ...
            request.Content = new StringContent("{\"fields\":" + item + "}", Encoding.UTF8, "application/json");
